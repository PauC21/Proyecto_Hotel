...
class CrearReservaHabitacionNoDisponibleTest(StaticLiveServerTestCase):
    """CP-RF-12-2: Intentar crear una reserva con habitación no disponible"""

    def setUp(self):
        chrome_options = Options()
        chrome_options.add_argument("--no-sandbox")
        chrome_options.add_argument("--disable-dev-shm-usage")
        # chrome_options.add_argument("--headless")  # Quita comentario si no quieres ver el navegador
        ...
        # Crear habitación ocupada
        self.room = Room.objects.create(
            room_number="102",
            room_type="Suite",
            price_per_night=200000,
            status="occupied"  # ❌ habitación no disponible
        )
        ...
        self.guest = Guest.objects.create(
            ...
            government_id="1122334455",
            address="Calle 987 #65-43"
        )
    ...
    def test_reserva_habitacion_no_disponible(self):
        driver = self.driver

        # 1️⃣ Login al admin (igual que 12_1)
        ...
        # 3️⃣ Llenar formulario de reserva con habitación no disponible
        ...
        self.take_screenshot("04_intento_guardar")
        ...
        print("✅ La reserva no se creó porque la habitación estaba ocupada")
